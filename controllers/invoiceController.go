...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("Error while fetching invoice")
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("Error while fetching order")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
		...
		if insertErr != nil {
			msg := fmt.Sprintf("Error while creating invoice")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
...
func UpdateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		filer := bson.M{"invoice_id": invoiceId}
